...
WORKFLOW+="o2-itsmft-stf-decoder-workflow ${ARGS_ALL} --ignore-noise-map --configKeyValues \"$ARGS_ALL_CONFIG\" --runmft --digits --no-clusters --no-cluster-patterns --nthreads 5 | "
